...
(function() {
    var faqData = [
        ...
        { q: 'Fintokeiって何？', a: 'トレーダーに向けて取引の教育と評価を提供するサービスです。デモ環境でスキルを磨き、優れたパフォーマンスを証明すると報酬やより大きな取引機会が得られます🔥', reactions: '🔥 31' },
        ...
        { q: '他との違いは？', a: '僕自身がほぼ毎日シナリオ動画を出して、質問にも直接答えてるところ。あとは独自ツールYTTと、430名以上のプロ輩出という結果ですね。口だけじゃなく数字で証明してます📊', reactions: '🔥 27 👏 14' },
...
function initPlanCarousel() {
    ...
    var current = 1; // Standard centered initially
    var total = slides.length;
    var isAnimating = false;
    ...
    function getLayout() {
        var isMobile = track.offsetWidth < 700;
        return {
            activeW: isMobile ? 300 : 420,
            inactiveW: isMobile ? 240 : 340,
            gap: isMobile ? 16 : 28,
            sideScale: isMobile ? 0.88 : 0.9
        };
    }
